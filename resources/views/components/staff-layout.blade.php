                ...
                <div class="flex justify-between h-16">
                    ...
                    <div class="flex items-center">
                        ...
                        <a href="{{ route('home') }}" class="shrink-0 flex items-center gap-2 group">
                            <div class="w-8 h-8 bg-white text-blue-700 rounded-lg flex items-center justify-center font-bold text-lg shadow-sm group-hover:scale-105 transition-transform">
                                A
                            </div>
